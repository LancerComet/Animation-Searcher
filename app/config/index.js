...
const config = {
  ...
  site: {
    caso: { name: '华盟', codeName: 'caso', fullName: 'China Animation Subtitle Organization', url: 'https://camoe.org', icon: 'http://tp4.sinaimg.cn/1843885343/180/1290319229/0', disabled: true },
    ...
    acgRip: { name: 'ACG.RIP', codeName: 'acgRip', fullName: 'ACG.RIP', url: 'https://acg.rip', icon: '', disabled: false }
  }
}
