    ...
    superAgent
        ...
        .end(function (superAgentError, superAgentResponse) {
            ...
            if (dmhyResultObject.pageLink) {
                var regExp = /href="/g;
                var replacedPageLink = dmhyResultObject.pageLink.replace(regExp, 'href="javascript:void(0)" class="pagination-item" ng-click="switchPage($event, \'dmhy\')" data-request-link="' + appConfig.site.dmhy.url);
